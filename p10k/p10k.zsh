# Generated by Powerlevel10k configuration wizard on 2022-01-04 at 23:49 +08.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 19497.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# slanted separators, sharp heads, blurred tails, 2 lines, solid, left frame,
...
() {
  ...
  # respectively.
  typeset -g POWERLEVEL9K_DIR_TRUNCATE_BEFORE_MARKER=flase
